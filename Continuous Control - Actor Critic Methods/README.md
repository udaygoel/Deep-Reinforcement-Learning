...
The project can be solved using one of the two versions of the environment. 
...
Once the environment has been set up, follow the instructions in `Continuous_Control.ipynb` to get started with training your own agent!
...
* checkpoint_critic.pth: The saved state dictionary values of the trained critic.
